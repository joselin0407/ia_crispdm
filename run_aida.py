...
async def main():
    ...
    print("═"*75)
    print(" Estoy lista para ayudarte a documentar, estandarizar y gobernar tus")
    print(" desarrollos de Machine Learning en Grupo Vanti.")
    print("\n ¿Cómo empezar? Solo dime:")
    print(" 👉 'AIDA, analiza el notebook main_gdp990_v1_expl_datos.ipynb y genera el Word'")
    print("═"*75 + "\n")
    ...
    while True:
        try:
            ...
            if user_input.lower() in ["exit", "quit", "salir"]:
                print("\n¡Hasta luego! Cerrando sesión en AIDA...")
                break
            ...
            print("\n[AIDA]: :gear: :thinking_face: Pensando...", end="\r")
            
            tokens_input = 0
            tokens_output = 0
            tokens_total = 0
            
            # Ejecución del agente (Si te falla aquí, intenta cambiar "for" por "async for")
